...
const TRACKED_SETS := [
	...
	"HINTS_CHARGE_ROLL", "HINTS_CHARGE_MOVE", "HINTS_DEPLOY",
	"HINTS_DEPLOY_STAGED", "HINTS_DEPLOY_REPOSITION", "HINTS_FOCUS",
	"HINTS_CARRY", "HINTS_CARRY_MOVE", "HINTS_CARRY_GROUP", "HINTS_MENU",
	"HINTS_MOVE", "HINTS_MOVE_STAGED", "HINTS_MOVE_LOCKED", "HINTS_FIGHT",
	"HINTS_FIGHT_PILE_IN", "HINTS_FIGHT_CONSOLIDATE",
]
...
func _run() -> void:
	...
	var code_sets := {
		...
		"HINTS_DEPLOY_STAGED": PAD_ROUTER.HINTS_DEPLOY_STAGED,
		"HINTS_DEPLOY_REPOSITION": PAD_ROUTER.HINTS_DEPLOY_REPOSITION,
		...
		"HINTS_FIGHT_PILE_IN": PAD_ROUTER.HINTS_FIGHT_PILE_IN,
		"HINTS_FIGHT_CONSOLIDATE": PAD_ROUTER.HINTS_FIGHT_CONSOLIDATE,
	}
