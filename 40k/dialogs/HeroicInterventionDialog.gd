...
# HeroicInterventionDialog - UI for Heroic Intervention stratagem during Charge phase
#
...
func setup(p_player: int, p_eligible_units: Array, p_charging_unit_name: String = "enemy unit") -> void:
	player = p_player
	eligible_units = p_eligible_units
	charging_unit_name = p_charging_unit_name
