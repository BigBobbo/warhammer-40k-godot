...
func _build_ui() -> void:
	...
	var _tsd_meta = vehicle_unit.get("meta", {})
	var vehicle_name = _tsd_meta.get("display_name", _tsd_meta.get("name", vehicle_unit_id))
	...
	vehicle_label.add_theme_font_size_override("font_size", 18)
	...
	targets_label.add_theme_font_size_override("font_size", 18)
