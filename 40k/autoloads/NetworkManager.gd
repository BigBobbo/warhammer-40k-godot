...
const DETERMINISTIC_ACTIONS: Array[String] = [
	...
	# Deployment
	"DEPLOY_UNIT", "COMPOSITE_DEPLOY", "EMBARK_UNITS_DEPLOYMENT", "ATTACH_CHARACTER_DEPLOYMENT",
	# Strategic Reserves / Deep Strike
	"PLACE_IN_RESERVES", "PLACE_REINFORCEMENT",
	# Scout Moves (no dice rolls, deterministic)
	"BEGIN_SCOUT_MOVE", "SET_SCOUT_MODEL_DEST", "CONFIRM_SCOUT_MOVE",
	"SKIP_SCOUT_UNIT", "END_SCOUT_MOVES",
