...
# Visual settings
const TERRAIN_COLOR_LOW = Color(0.4, 0.35, 0.3, 0.5)      # Light brown, less opaque
const TERRAIN_COLOR_MEDIUM = Color(0.35, 0.3, 0.25, 0.6)  # Medium brown
const TERRAIN_COLOR_TALL = Color(0.3, 0.25, 0.2, 0.7)     # Dark brown, more opaque
const BORDER_COLOR = Color(0.25, 0.2, 0.15, 1.0)          # Dark brown border
