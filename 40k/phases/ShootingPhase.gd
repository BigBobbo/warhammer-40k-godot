...
func _initialize_shooting() -> void:
	...
	if not can_shoot:
		log_phase_message("No units available for shooting - player must click 'End Shooting Phase' to continue")
		# DO NOT auto-complete - player must manually end the phase by clicking the button
