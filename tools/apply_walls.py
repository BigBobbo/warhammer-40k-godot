...
WALLS_TOP_HALF = {
    # tall_01 (top-mid small, rot_h=0): L-shape at the bottom-left corner.
    # Full wall on local west (= world LEFT) PLUS full wall on local south
    # (= world BOTTOM). Mirror tall_02 gets east + north (top-right L).
    "tall_01": [
        ("west", ["full"]),
        ("south", ["full"]),
    ],
